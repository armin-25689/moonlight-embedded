...
Arguments as '[color_primaries:p3],[light:0:100:400],[scale:fmt:size]'
color_primaries can use p3|bt2020|bt601|bt709.
light fill minDisplayLuminance:maxfall:maxDisplayLuminance.
...
Use color_primaries:p3 to change hdr bt2020 to hdr display p3.
Use light try to finish light tonemap.This may not supported now.
Note: this option may not work correctly because of FreeBSD 
HDR support or option implemention.
