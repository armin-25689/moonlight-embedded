...
<PLATFORM> can be vaapi, drm_vaapi, wayland_vaapi, software, drm, wayland, rk or fake etc.

Platform 'software/vaapi' will choose x11/wayland/gbm display automatically.
Platform 'X11' will force to x11 server.
...
=head1 KEYBOARD SHORTCUTS
 ...
 It could not grab the keyboard,try add write permition to
