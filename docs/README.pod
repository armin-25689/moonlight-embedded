...
software/x11/drm/wayland/drm_vaapi/x11_vaapi platform.
...
Note2: Only x11 and wayland server worked normaly now.
Note3: If want -nograb with drm platform to avoiding grab error: 
$ cat > s.sh <<-EOF
#!/bin/sh
stty -echo -isig
exec < /dev/null
