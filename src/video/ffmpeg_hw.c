...
static int vulkan_get_format(AVBufferRef *device_ref) {
  ...
  enum AVPixelFormat yuv444[] = { AV_PIX_FMT_NV24, AV_PIX_FMT_YUV444P, AV_PIX_FMT_UYVA, AV_PIX_FMT_NONE };
  enum AVPixelFormat yuv44410[] = { AV_PIX_FMT_YUV444P10, AV_PIX_FMT_XV30, AV_PIX_FMT_YUV444P16, AV_PIX_FMT_NONE };
