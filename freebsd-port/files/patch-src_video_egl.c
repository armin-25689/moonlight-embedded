--- src/video/egl.c.orig	2024-08-01 13:37:02 UTC
+++ src/video/egl.c
@@ -17,75 +17,237 @@
...
+  }
   if (display == EGL_NO_DISPLAY) {
     ...
     exit(EXIT_FAILURE);
@@ -101,7 +263,11 @@ void egl_init(EGLNativeDisplayType native_display, Nat
...
@@ -124,70 +290,201 @@ void egl_init(EGLNativeDisplayType native_display, Nat
     exit(EXIT_FAILURE);
   }
